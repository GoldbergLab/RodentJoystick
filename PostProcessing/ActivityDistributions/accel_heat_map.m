...
% accel_heat_map(dirlist, [ax, data, bin])
%
%   plots the median of the acceleration profile given by the trajectories
%   in dirlist for a group of cells with size defined by bin
%
% ARGUMENTS:
%
