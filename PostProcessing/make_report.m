function [ output_args ] = make_report(dirlist)
...
hold_time_distr(dirlist, 20, 1500, 0, 3, axlst(7));
multi_js_touch_dist(dirlist, 0.25, 150, 300, 0, axlst(8));
multi_js_touch_dist(dirlist, 0.25, 30, 300, 0, axlst(9));
